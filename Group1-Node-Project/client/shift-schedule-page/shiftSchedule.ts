...
const renderWeekDisplayer = () =>{
  ...
  const nextSunday = new Date(todayDate.getFullYear(), todayDate.getMonth(), (todayDate.getDate()-todayDate.getDay())+7).toDateString();
  const nextSaturday = new Date(todayDate.getFullYear(), todayDate.getMonth(), (todayDate.getDate() + (6 - todayDate.getDay()))+7).toDateString();
